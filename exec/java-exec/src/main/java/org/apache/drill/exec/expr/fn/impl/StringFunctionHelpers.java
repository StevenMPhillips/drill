...
public class StringFunctionHelpers {
  ...
  public static long varCharToLong(final int start, final int end, ArrowBuf buffer){
    if ((end - start) ==0) {
  ...
  public static int varCharToInt(final int start, final int end, ArrowBuf buffer){
    if ((end - start) ==0) {
      //empty, not a valid number
