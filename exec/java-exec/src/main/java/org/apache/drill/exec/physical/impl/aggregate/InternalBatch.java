...
public class InternalBatch implements Iterable<VectorWrapper<?>>{
  ...
  public InternalBatch(RecordBatch incoming, BufferAllocator allocator) {
    this(incoming, null, allocator);
  }

  public InternalBatch(RecordBatch incoming, VectorWrapper[] ignoreWrappers, BufferAllocator allocator){
    ...
    this.container = VectorContainer.getTransferClone(incoming, ignoreWrappers, allocator);
  }
